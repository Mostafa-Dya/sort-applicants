    ...
    public function acceptApplicants(Request $request)
    {
        ...
        foreach ($jobDescriptions as $jobDescription) {
            ...
            foreach ($applicants as $applicant) {
                ...
                if ($filledVacancies < $jobDescription->vacancies && $applicant->status == 1 && $jobDescription->status == 1) {
                    // Check if the applicant has already been accepted for another job
